...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.black),//Bu şekilde textstyle'dai default değelerle beraber istediğimiz eğerleri de değiştirerek kopyalayabiliyoruz.
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.w600, color: Colors.black),
    titleMedium: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.5)),

    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w500, color: Colors.white),
